...
public class ProductListMainDiscountDto {
    ...
    public ProductListMainDiscountDto(int productNo, String productName, int productPrice, String ProductImgNewName, String productSimpleContent, int discountPrice) {
