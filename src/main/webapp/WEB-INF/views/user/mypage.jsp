...
<jsp:include page="/front/nav.jsp" flush="true"/>
<%
    int userno = -1;
    int isvalid = -1;
...
<div>
    <form action="add-profile" method="post" id="frm">
        ...
        <div>
            <div>
                <p>닉네임을 입력해 주세요</p>
                <input id="userNickname" name="userNickname" type="text" value="" placeholder="닉네임을 입력해 주세요"
        ...
        <div>
            <div>
                <input id="userAddress" name="userAddress" type="text" value="" placeholder="주소를 입력해 주세요" maxlength="50"
                       required="required">
            </div>
        </div>
        <div>
            <div>
                <input id="userPhone" name="userPhone" type="text" value="" placeholder="전화번호를 입력해 주세요" maxlength="50"
                       required="required">
            </div>
        </div>
        <div>
